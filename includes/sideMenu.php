<nav id="sideMenu" class="">
    ...
    <hr>
    <ul>
        <li><a href="about.php" class="coolHover">About Me</a></li>
        <li><a href="index.php#projects" class="coolHover">My Portfolio</a></li>
        <li><a href="examples.php" class="coolHover">Coding Examples</a></li>
        <li><a href="scs.php" class="coolHover">SCS Scheme</a></li>
    </ul>
    <hr>
